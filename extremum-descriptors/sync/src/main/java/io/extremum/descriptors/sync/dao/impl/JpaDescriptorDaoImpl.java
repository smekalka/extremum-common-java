...
public class JpaDescriptorDaoImpl extends JpaDescriptorDao {

    public JpaDescriptorDaoImpl(RedissonClient redissonClient, DescriptorRepository descriptorRepository,
        ...
        super(
                ...
                redissonClient.getLocalCachedMap(
                        ...
                        FlexibleLocalCachedMapOptions
                                ...
                                .shouldBeCached(JpaDescriptorDaoImpl::descriptorWillNeverChange)
    ...
    private static boolean isBlankDescriptor(CacheValue cacheValue) {
        ...
        return descriptor.getReadiness() == Descriptor.Readiness.BLANK;
    }
}
