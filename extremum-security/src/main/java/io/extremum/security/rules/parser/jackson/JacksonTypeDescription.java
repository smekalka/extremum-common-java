...
final class JacksonTypeDescription implements TypeDescription {
    ...
    public void setFieldTypes(JsonSerializer<?> ser, TypeQuery typeQuery) {
    ...
    static com.google.api.expr.v1alpha1.Type findTypeForJacksonType(JavaType type, TypeQuery typeQuery) {
