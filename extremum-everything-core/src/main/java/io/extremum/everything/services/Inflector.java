...
public class Inflector {
    ...
    public String singularize(Object word) {
        ...
        if(((String)word).toLowerCase().endsWith("collection")){
            return ((String) word).toLowerCase().substring(0, ((String)word).toLowerCase().indexOf("collection"));
        }
    ...
    protected void initialize() {
        ...
        inflect.addIrregular("mouse", "mice");
        inflect.addIrregular("foot", "feet");
        inflect.addIrregular("woman", "women");
        inflect.addIrregular("louse", "lice");
        inflect.addIrregular("tooth", "teeth");
        inflect.addIrregular("ox", "oxen");
