...
@SpringBootTest(
        classes = {CommonConfiguration.class, SpringHandlerExceptionTestConfiguration.class},
        properties = {"spring.main.web-application-type=reactive"}
)
@TestInstance(TestInstance.Lifecycle.PER_CLASS)
public class SpringHandlerReactiveExtremumExceptionHandlerEndToEndTest extends TestWithServices {
