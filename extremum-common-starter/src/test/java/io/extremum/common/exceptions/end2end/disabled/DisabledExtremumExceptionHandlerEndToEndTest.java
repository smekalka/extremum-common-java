...
@SpringBootTest(classes = {CommonConfiguration.class, DisabledHandlerExceptionTestConfiguration.class},
        properties = {"exceptions.disable-extremum-handlers=true"})
@TestInstance(TestInstance.Lifecycle.PER_CLASS)
@AutoConfigureMockMvc
public class DisabledExtremumExceptionHandlerEndToEndTest extends TestWithServices {
